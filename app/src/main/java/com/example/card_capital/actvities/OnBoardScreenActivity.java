...
import com.example.card_capital.adapter.Slide_Adapter;
    ...
    ViewPager.OnPageChangeListener changeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            if(position == 0){
                ...
                animation = AnimationUtils.loadAnimation(OnBoardScreenActivity.this,R.anim.slide_animation);
